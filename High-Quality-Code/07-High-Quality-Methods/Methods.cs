...
namespace Methods
{
    class Methods
    {
        ...
        static void PrintAsNumber(object number, string format)
        {
            ...
            {
                throw new ArgumentException("Wrong format.", "format");
            }
        }
        ...
        static void CheckHorizonralOrVertical(double x1, double y1, double x2, double y2,
        ...
        static void Main()
        {
            ...
            CheckHorizonralOrVertical(3, -1, 3, 2.5, out horizontal, out vertical);
